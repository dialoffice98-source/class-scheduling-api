...
def extract_sets(course_dict, room_dict, settings):
    ...
    sets['room_names'] = {room_id: room_info['RuanganNama'] for room_id, room_info in room_dict.items()}
    return sets
...
def extract_params(course_dict, room_dict, settings):
    ...
    for course in course_dict.values():
        ...
        class_details[course_code][class_id][session_id] = {
            ...
            'lecturer_name': course['DosenNama'],
            'course_name': course['MatakuliahNama'],
    ...
    # room_capacity and room_name
    params['room_capacity'] = {room_id: room_info['KapasitasRuangan'] for room_id, room_info in room_dict.items()}
